...
[cite_start]Cada historia de usuario incluye Criterios de Aceptación redactados en formato Gherkin (Given-When-Then)[cite: 343], como lo exige el enunciado, para asegurar que los requisitos sean comprobables y no dejen lugar a ambigüedades. [cite_start]Se han incluido historias para la aplicación principal, la Landing Page (con el rol de "Visitante") [cite: 345] [cite_start]y Technical Stories para el desarrollo del backend (con el rol de "Developer")[cite: 347, 348].
...
| :--- | :--- | :--- | :--- | :--- |
| **_Historias para la Aplicación Web_** |
...
| **_Technical Stories (para la API)_** |
...
| **_Historias para la Landing Page_** |
